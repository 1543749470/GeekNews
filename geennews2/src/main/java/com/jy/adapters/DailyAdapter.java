...
public class DailyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    List<StoriesBean> beforeStories=new ArrayList<>();
    boolean isBefore;
    String title="今日新闻";
    Context context;
...
//                    Glide.with(context).load(storiesBean.getImages().get(0)).into(((ItemViewHolder) viewHolder).img);
                    ImageLoaderUtils.showImg(storiesBean.getImages().get(0),((ItemViewHolder) viewHolder).img);
                }
...
//            viewHolder.img
                ...
                StoriesBean storiesBean = beforeStories.get(i);
                if (storiesBean.getImages() != null && storiesBean.getImages().size() > 0) {
...
//                    Glide.with(context).load(storiesBean.getImages().get(0)).into(((ItemViewHolder) viewHolder).img);
    ...
    public void initBeforeData(List<StoriesBean> stories) {
